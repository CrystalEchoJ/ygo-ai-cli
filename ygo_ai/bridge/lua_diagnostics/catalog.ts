import { invokeCommand, tauriBridge } from './tauri_stub';
import { luaCatalog as generatedLuaCatalog } from './catalog.generated';
import type { LuaCatalog, LuaConstantItem, LuaFunctionItem, LuaSnippetItem } from './types';
...
export function parseConstantCategory(line: string) {
...
export function parseConstants(text: string): LuaConstantItem[] {
